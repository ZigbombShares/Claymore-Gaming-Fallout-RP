--[[ Client Config ]]--
	...
	Prometheus.WebsiteUrl = "http://claymore.website/store/fallout/" -- Your websites URL that will open when they click on the donation button in the menu, has to start with http:// or https://

	Prometheus.Notify.Header = "FALLOUT"
	...
	Prometheus.Menu.Header = "FALLOUT"
